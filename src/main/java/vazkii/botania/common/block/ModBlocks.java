...
public final class ModBlocks {
	...
	public static void init() {
		...
		livingwood = new BlockLivingwood(id++);
		specialFlower = new BlockSpecialFlower(id++);
		spreader = new BlockSpreader(id++);
		pool = new BlockPool(id++);
		runeAltar = new BlockRuneAltar(id++);
		unstableBlock = new BlockUnstable(id++);
		pylon = new BlockPylon(id++);
		pistonRelay = new BlockPistonRelay(id++);
		distributor = new BlockDistributor(id++);
		manaBeacon = new BlockManaBeacon(id++);
		manaVoid = new BlockManaVoid(id++);
		manaDetector = new BlockManaDetector(id++);
		enchanter = new BlockEnchanter(id++);
		turntable = new BlockTurntable(id++);
		...
		shinyFlower = new BlockShinyFlower(id++);
		platform = new BlockPlatform(id++);
		alfPortal = new BlockAlfPortal(id++);
		dreamwood = new BlockDreamwood(id++);
		...
		floatingFlower = new BlockFloatingFlower(id++);
		tinyPotato = new BlockTinyPotato(id++);
		spawnerClaw = new BlockSpawnerClaw(id++);
		reedBlock = new BlockReeds(id++);
		thatch = new BlockThatch(id++);
		customBrick = new BlockCustomBrick(id++);
		enderEye = new BlockEnderEye(id++);
		starfield = new BlockStarfield(id++);
//		rfGenerator	= new BlockRFGenerator(id++);
		elfGlass = new BlockElfGlass(id++);
		brewery = new BlockBrewery(id++);
		manaGlass = new BlockManaGlass(id++);
		terraPlate = new BlockTerraPlate(id++);
		redStringContainer = new BlockRedStringContainer(id++);
		redStringDispenser = new BlockRedStringDispenser(id++);
		redStringFertilizer = new BlockRedStringFertilizer(id++);
		redStringComparator = new BlockRedStringComparator(id++);
		redStringRelay = new BlockRedStringRelay(id++);
		floatingSpecialFlower = new BlockFloatingSpecialFlower(id++);
		manaFlame = new BlockManaFlame(id++);
		prism = new BlockPrism(id++);
		dirtPath = new BlockDirtPath(id++);
		enchantedSoil = new BlockEnchantedSoil(id++);
		petalBlock = new BlockPetalBlock(id++);
		corporeaIndex = new BlockCorporeaIndex(id++);
		corporeaFunnel = new BlockCorporeaFunnel(id++);
		endStoneBrick = new BlockEndStoneBrick(id++);
		mushroom = new BlockModMushroom(id++);
		pump = new BlockPump(id++);
		doubleFlower1 = new BlockModDoubleFlower(id++, false);
		doubleFlower2 = new BlockModDoubleFlower(id++, true);
		fakeAir = new BlockFakeAir(id++);
		blazeBlock = new BlockBlaze(id++);
		corporeaInterceptor = new BlockCorporeaInterceptor(id++);
		corporeaCrystalCube = new BlockCorporeaCrystalCube(id++);
		incensePlate = new BlockIncensePlate(id++);
		hourglass = new BlockHourglass(id++);
		ghostRail = new BlockGhostRail(id++);
		sparkChanger = new BlockSparkChanger(id++);
		root = new BlockRoot(id++);
		felPumpkin = new BlockFelPumpkin(id++);
		cocoon = new BlockCocoon(id++);
		lightRelay = new BlockLightRelay(id++);
		lightLauncher = new BlockLightLauncher(id++);
		manaBomb = new BlockManaBomb(id++);
		cacophonium = new BlockCacophonium(id++);
		bellows = new BlockBellows(id++);
		bifrostPerm = new BlockBifrostPerm(id++);
		...
		shimmerwoodPlanks = new BlockShimmerwoodPlanks(id++);
		avatar = new BlockAvatar(id++);
		altGrass = new BlockAltGrass(id++);


		ModFluffBlocks.init();
/*
		//todo register tags for blocks
		for(int i = 0; i < 16; i++)
