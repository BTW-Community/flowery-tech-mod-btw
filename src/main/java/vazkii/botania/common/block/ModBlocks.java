...
public final class ModBlocks {
	...
	public static void init() {
		flower = new BlockModFlower(421);
		altar = new BlockAltar(422);
		livingrock = new BlockLivingrock(423);
		livingwood = new BlockLivingwood(424);
		specialFlower = new BlockSpecialFlower(425);
		spreader = new BlockSpreader(426);
		pool = new BlockPool(427);
		runeAltar = new BlockRuneAltar(428);
		unstableBlock = new BlockUnstable(429);
		pylon = new BlockPylon(430);
		pistonRelay = new BlockPistonRelay(431);
		distributor = new BlockDistributor(432);
		manaBeacon = new BlockManaBeacon(433);
		manaVoid = new BlockManaVoid(434);
		manaDetector = new BlockManaDetector(435);
		enchanter = new BlockEnchanter(436);
		turntable = new BlockTurntable(437);
		tinyPlanet = new BlockTinyPlanet(438);
		alchemyCatalyst = new BlockAlchemyCatalyst(439);
		openCrate = new BlockOpenCrate(440);
		forestEye = new BlockForestEye(441);
		storage = new BlockStorage(442);
		forestDrum = new BlockForestDrum(443);
		shinyFlower = new BlockShinyFlower(444);
		platform = new BlockPlatform(445);
		alfPortal = new BlockAlfPortal(446);
		dreamwood = new BlockDreamwood(447);
		conjurationCatalyst = new BlockConjurationCatalyst(448);
		bifrost = new BlockBifrost(449);
		solidVines = new BlockSolidVines(450);
		buriedPetals = new BlockBuriedPetals(451);
		prismarine = new BlockPrismarine(452);
		seaLamp = new BlockSeaLamp(453);
		floatingFlower = new BlockFloatingFlower(454);
		tinyPotato = new BlockTinyPotato(455);
		spawnerClaw = new BlockSpawnerClaw(456);
		reedBlock = new BlockReeds(457);
		thatch = new BlockThatch(458);
		customBrick = new BlockCustomBrick(459);
		enderEye = new BlockEnderEye(460);
		starfield = new BlockStarfield(461);
//		rfGenerator	= new BlockRFGenerator(462);
		elfGlass = new BlockElfGlass(463);
		brewery = new BlockBrewery(464);
		manaGlass = new BlockManaGlass(465);
		terraPlate = new BlockTerraPlate(466);
		redStringContainer = new BlockRedStringContainer(467);
		redStringDispenser = new BlockRedStringDispenser(468);
		redStringFertilizer = new BlockRedStringFertilizer(469);
		redStringComparator = new BlockRedStringComparator(470);
		redStringRelay = new BlockRedStringRelay(471);
		floatingSpecialFlower = new BlockFloatingSpecialFlower(472);
		manaFlame = new BlockManaFlame(473);
		prism = new BlockPrism(474);
		dirtPath = new BlockDirtPath(475);
		enchantedSoil = new BlockEnchantedSoil(476);
		petalBlock = new BlockPetalBlock(477);
		corporeaIndex = new BlockCorporeaIndex(478);
		corporeaFunnel = new BlockCorporeaFunnel(479);
		endStoneBrick = new BlockEndStoneBrick(480);
		mushroom = new BlockModMushroom(481);
		pump = new BlockPump(481);
		doubleFlower1 = new BlockModDoubleFlower(482, false);
		doubleFlower2 = new BlockModDoubleFlower(483, true);
		fakeAir = new BlockFakeAir(484);
		blazeBlock = new BlockBlaze(485);
		corporeaInterceptor = new BlockCorporeaInterceptor(486);
		corporeaCrystalCube = new BlockCorporeaCrystalCube(487);
		incensePlate = new BlockIncensePlate(488);
		hourglass = new BlockHourglass(489);
		ghostRail = new BlockGhostRail(490);
		sparkChanger = new BlockSparkChanger(491);
		root = new BlockRoot(492);
		felPumpkin = new BlockFelPumpkin(493);
		cocoon = new BlockCocoon(493);
		lightRelay = new BlockLightRelay(494);
		lightLauncher = new BlockLightLauncher(495);
		manaBomb = new BlockManaBomb(496);
		cacophonium = new BlockCacophonium(497);
		bellows = new BlockBellows(498);
		bifrostPerm = new BlockBifrostPerm(499);
		cellBlock = new BlockCell(500);
		redStringInterceptor = new BlockRedStringInterceptor(501);
		gaiaHead = new BlockGaiaHead(502);
		corporeaRetainer = new BlockCorporeaRetainer(503);
		teruTeruBozu = new BlockTeruTeruBozu(504);
		shimmerrock = new BlockShimmerrock(505);
		shimmerwoodPlanks = new BlockShimmerwoodPlanks(506);
