...
public class TileOpenCrate extends TileSimpleInventory {
	...
	public boolean canEject() {
		...
		return blockBelow == null || blockBelow.isAir(worldObj, xCoord, yCoord - 1, zCoord) || blockBelow.getCollisionBoundingBoxFromPool(worldObj, xCoord, yCoord - 1, zCoord) == null;
	}
