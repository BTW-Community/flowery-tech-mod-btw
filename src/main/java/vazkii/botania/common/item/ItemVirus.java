...
import net.minecraft.src.ai.attributes.BaseAttributeMap;
import net.minecraft.src.ai.attributes.IAttribute;
import net.minecraft.src.ai.attributes.IAttributeInstance;
