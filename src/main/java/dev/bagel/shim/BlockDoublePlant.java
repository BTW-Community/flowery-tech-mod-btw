...
public class BlockDoublePlant extends BlockBush/* implements IGrowable, IShearable*/
{
    ...
    @Environment(EnvType.CLIENT)
    public Icon func_149888_a(boolean p_149888_1_, int p_149888_2_)
    {
     ...
     */
    public void getSubBlocks(int itemIn, CreativeTabs tab, List list)
    {
        for (int i = 0; i < this.doublePlantBottomIcons.length; ++i)
        {
    ...
    public ArrayList<ItemStack> onSheared(ItemStack item, IBlockAccess world, int x, int y, int z, int fortune)
    {
        ...
        if (type == 3 || type == 2)
            ret.add(new ItemStack(Block.tallGrass, 2, type == 3 ? 2 : 1));
        return ret;
    }
}