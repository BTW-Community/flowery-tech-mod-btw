...
public class EarlyRiser implements Runnable {
    ...
    public void run() {
        ...
        //EnumArmorMaterial
        ClassTinkerers.enumBuilder(resolver.mapClassName("intermediary", "net.minecraft.class_1029"), int.class, int[].class, int.class)
                ...
                .build();
        //EnumToolMaterial
        ClassTinkerers.enumBuilder(resolver.mapClassName("intermediary", "net.minecraft.class_1070"), int.class, int.class, float.class, float.class, int.class, int.class, int.class)
                .addEnum("MANASTEEL", 3, 300, 6.2F, 2F, 20, 25, 2)
                .addEnum("ELEMENTIUM", 3, 720, 6.2F, 2F, 20, 35, 3)
                .addEnum("TERRASTEEL", 4, 2300, 9F, 3F, 26, 30, 5)
                .build();

        //EnumRarity
        ClassTinkerers.enumBuilder(resolver.mapClassName("intermediary", "net.minecraft.class_1081"), int.class, String.class)
