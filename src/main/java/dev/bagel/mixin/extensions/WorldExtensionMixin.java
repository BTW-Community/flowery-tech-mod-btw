...
import dev.bagel.interfaces.WorldExtensions;
...
@Mixin(World.class)
public abstract class WorldExtensionMixin implements WorldExtensions, IBlockAccess {
    @Shadow public abstract boolean setBlock(int par1, int par2, int par3, int par4);
